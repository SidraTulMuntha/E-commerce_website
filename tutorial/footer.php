...
$username = $city = $email = "";
$username_err = $city_err = $email_err = "";
...
if(empty($username_err) && empty($city_err) && empty($email_err))
{
    $sql = "INSERT INTO ship (username, city,email) VALUES (?, ?,?)";
    $stmt = mysqli_prepare($conn, $sql);
    if ($stmt)
    {
        mysqli_stmt_bind_param($stmt, "sss", $param_username, $param_city,$param_email);
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-12">
                ...
                <form class="form-row">
                    ...
                    <div class="col">
                        <input type="button" onclick="location.href='subscribe.php'" class="btn btn-primary mb-2";>  <- Paisa Hi Paisa</input>
                    </div>
                </form>
            </div>
