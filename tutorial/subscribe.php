...
$username = $city = $email = $category="";
$username_err = $city_err = $email_err = $category_err = "";
...
if ($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT ID FROM colab WHERE username = ?";
...
if(empty(trim($_POST['category']))){
    $category_err = "category cannot be blank";
}
else{
    $category = trim($_POST['category']);
}
// If there were no errors, go ahead and insert into the database
if(empty($username_err) && empty($city_err) && empty($email_err) && empty($category_err))
{
    $sql = "INSERT INTO colab (username, city,email,category) VALUES (?, ?,?,?)";
    $stmt = mysqli_prepare($conn, $sql);
    if ($stmt)
    {
        mysqli_stmt_bind_param($stmt, "ssss", $param_username, $param_city,$param_email,$param_category);
...
<div class="col-md-6">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control"name="category" id="inputFname">
  </div>
  ...
  <div class="col-12">
    <button type="submit" class="btn btn-primary" action="mail.php">Proceed</button>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-12">
                ...
                <form class="form-row">
                    ...
                    <div class="col">
                        <button onclick="return confirm('Please proceed First..!')" class="btn btn-primary mb-2">Subscribe</button>
                    </div>
                </form>
            </div>
